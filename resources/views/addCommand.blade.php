    ...
    <div class="container mt-5">
        ...
        <form method="post" action="insertReply">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="command" class="form-control" id="exampleInputEmail1">

            </div>

            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">إدخل الرد للأمر</label>
                <textarea class="form-control" name="reply" id="exampleFormControlTextarea1" rows="4"></textarea>
            </div>
    ...
    <div class="container mt-5">
        ...
        <form method="post" action="insertCommand" class="mb-5 ">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="commandOptions" class="form-control" id="exampleInputEmail1">
            </div>
